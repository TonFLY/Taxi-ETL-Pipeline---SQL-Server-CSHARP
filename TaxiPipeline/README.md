...
- [Material de Estudos e Referências](#material-de-estudos-e-referências)
...
Este projeto foi construído com base em vivência profissional no dia a dia com **SQL Server** e **C#**, complementada pelos seguintes materiais de estudo e documentações oficiais:

### Curso

| Curso | Plataforma | Instrutor |
|-------|------------|-----------|
| [Programação Orientada a Objetos com C#](https://www.udemy.com/course/programacao-orientada-a-objetos-csharp/) | Udemy | Nelio Alves |

### Documentação Oficial — C# / .NET

| Documentação | Link |
|--------------|------|
| C# Language Reference | https://learn.microsoft.com/pt-br/dotnet/csharp/ |
| .NET 9 Documentation | https://learn.microsoft.com/pt-br/dotnet/core/whats-new/dotnet-9/ |
| Dependency Injection in .NET | https://learn.microsoft.com/pt-br/dotnet/core/extensions/dependency-injection |
| Configuration in .NET | https://learn.microsoft.com/pt-br/dotnet/core/extensions/configuration |
| Logging in .NET | https://learn.microsoft.com/pt-br/dotnet/core/extensions/logging |
| `Microsoft.Data.SqlClient` | https://learn.microsoft.com/pt-br/sql/connect/ado-net/microsoft-ado-net-sql-server |
| `SqlBulkCopy` Class | https://learn.microsoft.com/pt-br/dotnet/api/microsoft.data.sqlclient.sqlbulkcopy |
| `HttpClient` Class | https://learn.microsoft.com/pt-br/dotnet/api/system.net.http.httpclient |
| Clean Architecture (.NET) | https://learn.microsoft.com/pt-br/dotnet/architecture/modern-web-apps-azure/ |

### Documentação Oficial — SQL Server / T-SQL

| Documentação | Link |
|--------------|------|
| T-SQL Reference | https://learn.microsoft.com/pt-br/sql/t-sql/language-reference |
| `TRY_CAST` | https://learn.microsoft.com/pt-br/sql/t-sql/functions/try-cast-transact-sql |
| `HASHBYTES` (SHA2_256) | https://learn.microsoft.com/pt-br/sql/t-sql/functions/hashbytes-transact-sql |
...
| Indexes (CREATE INDEX) | https://learn.microsoft.com/pt-br/sql/t-sql/statements/create-index-transact-sql |
| Schemas | https://learn.microsoft.com/pt-br/sql/relational-databases/security/authentication-access/create-a-database-schema |

### Bibliotecas de Terceiros

| Biblioteca | Uso no Projeto | Link |
|------------|----------------|------|
| Parquet.Net | Leitura de arquivos Parquet | https://github.com/aloneguid/parquet-dotnet |
